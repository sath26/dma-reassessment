...
public class AddEditNoteActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_TITLE = "com.example.todofinal.EXTRA_TITLE";
    public static final String EXTRA_DESCRIPTION = "com.example.todofinal.EXTRA_DESCRIPTION";
    public static final String EXTRA_PRIORITY = "com.example.todofinal.EXTRA_PRIORITY";
    public static final String EXTRA_ID = "com.example.todofinal.EXTRA_ID";
