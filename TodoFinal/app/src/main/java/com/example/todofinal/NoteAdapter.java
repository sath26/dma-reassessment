...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.NoteHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull NoteAdapter.NoteHolder noteHolder, int i) {
        Note currentNote = notes.get(i);
        noteHolder.textViewTitle.setText(currentNote.getTitle());
        noteHolder.textViewDescription.setText(currentNote.getDescribtion());
    ...
    //for getting exact position of item for swiping function
